...
__decorate([
    ...
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.UUID, field: 'history_id', allowNull: false, defaultValue: sequelize_1.UUIDV4 }),
...
__decorate([
    ...
    __metadata("design:type", String)
], History.prototype, "image", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, defaultValue: 'esun' }),
    __metadata("design:type", String)
], History.prototype, "esun", void 0);
History = __decorate([
